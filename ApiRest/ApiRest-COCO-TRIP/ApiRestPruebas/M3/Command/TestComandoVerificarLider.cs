...
{
  /// <summary>
  /// Pruebas unitarias de ComandoVerificarLider
  /// </summary>
  [TestFixture]
  public class TestComandoVerificarLider
  {
    ...
    private const string ScriptsSetUp = "ScriptsSetUpTestComandoVerificarLider.txt";
    ...
    [Category("Comando")]
    [Test]
    public void TestComandoVerificarLiderExitoso()
    {
      Assert.DoesNotThrow(ComandoVerificarLiderExitoso);
    }

    public void ComandoVerificarLiderExitoso()
    {
      comando = FabricaComando.CrearComandoVerificarLider(listaGrupo[0].Id, listaUsuario[0].Id);
      comando.Ejecutar();
    }
    ...
    [Category("Comando")]
    [Test]
    public void TestComandoVerificarLiderFallo()
    {
      Assert.Catch<HttpResponseException>(ComandoVerificarLiderFallo);
    }

    public void ComandoVerificarLiderFallo()
    {
      comando = FabricaComando.CrearComandoVerificarLider(listaGrupo[0].Id, listaUsuario[1].Id);
      comando.Ejecutar();
    }
  }
