...
{
  /// <summary>
  /// Pruebas unitarias de ComandoConsultarMiembroSinGrupo
  /// </summary>
  [TestFixture]
  public class TestComandoConsultarMiembroSinGrupo
  {
    ...
    private const string ScriptsSetUp = "ScriptsSetUpTestComandoConsultarMiembroSinGrupo.txt";
    ...
    [Category("Comando")]
    [Test]
    public void TestComandoConsultarMiembroSinGrupoExitoso()
    {
      comando = FabricaComando.CrearComandoConsultarMiembroSinGrupo(listaGrupo[1].Id, listaUsuario[1].Id);
      comando.Ejecutar();
      List<Entidad> lista = comando.RetornarLista();
      Assert.AreEqual(true, lista.Count == 1 && lista[0].Id == listaUsuario[0].Id);
    }
  }
