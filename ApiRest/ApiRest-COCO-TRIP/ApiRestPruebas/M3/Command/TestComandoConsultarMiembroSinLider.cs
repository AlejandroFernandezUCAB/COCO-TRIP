...
{
  /// <summary>
  /// Pruebas unitarias de ComandoConsultarMiembroSinLider
  /// </summary>
  [TestFixture]
  public class TestComandoConsultarMiembroSinLider
  {
    ...
    private const string ScriptsSetUp = "ScriptsSetUpTestComandoConsultarMiembroSinLider.txt";
    ...
    [Category("Comando")]
    [Test]
    public void TestComandoConsultarMiembroSinLiderExitoso()
    {
      comando = FabricaComando.CrearComandoConsultarMiembroSinLider(listaGrupo[0].Id);
      comando.Ejecutar();
      List<Entidad> lista = comando.RetornarLista();
      Assert.AreEqual(true, lista.Count == 2 && lista[0].Id != listaGrupo[0].Lider && lista[1].Id != listaGrupo[0].Lider);
    }
  }
