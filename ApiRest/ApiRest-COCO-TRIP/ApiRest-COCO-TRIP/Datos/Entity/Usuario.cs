...
namespace ApiRest_COCO_TRIP.Datos.Entity
{
    public class Usuario : Entidad
    {
        ...
        public Usuario( string nombre, string apellido, string nombreUsuario, string fechaDeNacimiento, string genero)
        {
            ...
            try
            {
                this.FechaNacimiento = Convert.ToDateTime(fechaDeNacimiento);
            }
